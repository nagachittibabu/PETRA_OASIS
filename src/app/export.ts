...
export const aboutcards = [
    {
        ...
        "para": "Specialization in Civil Construction and MEP Services (Mechanical, Electrical, and Plumbing), demonstrating the capacity to handle a project's full technical scope from structure to systems."
    },
    {
        "title": "Commitment to Quality & Safety:",
        "para": "Adherence to strict UAE regulatory standards and international best practices in construction, ensuring projects are delivered with superior material quality and zero-tolerance safety protocols."
    }, {
        "title": "Client-Centric Collaboration:",
        "para": "A foundation built on trust, innovation, and collaboration with clients and stakeholders, ensuring transparent communication and alignment throughout the project lifecycle."
    },
]
