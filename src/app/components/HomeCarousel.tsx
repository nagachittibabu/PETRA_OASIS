...
const HomeCarousel = () => {
  ...
  return (
    <div className="w-full h-[400px] xl:h-screen lg:h-screen md:h-[550px] sm:h-[500px] relative overflow-hidden flex items-center justify-center bg-blue-900">
      <div className='w-full h-full'>
        {/* Static Image */}
        <div
          className={`absolute top-10 left-0 w-[40%] xl:w-[35%] lg:w-[45%] md:w-[45%] sm:w-[40%] h-full z-0 transition-opacity duration-1000 z-100`}
        >
          <div>
            <Image
        ...
        <div className='xl:w-[40%] lg:w-[45%] md:w-[50%] sm:w-[50%] h-max absolute xl:left-[50%] xl:top-[40%]  lg:left-[50%] lg:top-[40%] md:left-[45%]  md:top-[40%] sm:left-[45%] sm:top-[40%] text-white  text-left p-2  z-100'>
